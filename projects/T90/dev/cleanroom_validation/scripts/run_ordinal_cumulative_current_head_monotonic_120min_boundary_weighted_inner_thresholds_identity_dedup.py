...
DEFAULT_CONFIG_PATH = CLEANROOM_DIR / "configs" / "ordinal_cumulative_current_head_monotonic_120min_boundary_weighted_inner_thresholds_identity_dedup.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Test inner-threshold-only boundary-aware sample weighting on the strongest identity-deduped simple baseline.")
    ...
    lines = [
        "# Boundary-Weighted Inner Thresholds Summary",
        "",
        ...
        "- Intervention: sample-weight only on inner thresholds, outer thresholds keep default training",
